...
# 定义股票列表
stock_list = ["SH.600519","SH.601398","SH.600941","SH.601939","SH.601628","SH.601288",
               ...
               "SH.600372","SZ.300003"] + [
               "SH.601857", "SH.600938", "SH.600028", "SH.600339", "SH.600941", "SH.601728",
...
try:
    ...
    if ret == ft.RET_OK:
        # 筛选出今日没有成交量的股票
        zero_volume_stocks = data[data['volume'] == 0]['code'].tolist()
        if zero_volume_stocks:
            print("今日没有成交量的股票列表：", zero_volume_stocks)
        else:
            print("{今日在列表中，没有股票停牌}")
    else:
        print("获取行情数据失败：", data)
